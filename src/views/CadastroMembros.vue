      ...
      <div class="box-3">
        ...
        <div class="coluna-direita">
          <form method="get" action="">
            ...
            <select class="cargo-comissoes" name="cargo-comissoes">
...
.cargos input[type="radio"] {
  all: unset;
}
.cargos input[type="radio"]:checked + span {
  color: #d91b5c;
  font-weight: 700;
}
</style>